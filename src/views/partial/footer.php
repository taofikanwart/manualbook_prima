    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                ...
                <span class="text-muted text-center text-sm-left d-block d-sm-inline-block"><a href="https://rsuppersahabatan.co.id" class="text-muted" target="_blank">RSUP Persahabatan</a>.</span>
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted"><a href="#" target="_blank">Taofik Anwar</a>. All rights reserved.</span>
            </div>
        </div>
    </div>
</footer>
